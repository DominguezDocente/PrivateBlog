...
namespace PrivateBlog.Web.Controllers
{
    public class RolesController : Controller
    {
        ...
        {
            Response<PaginationResponse<PrivateBlogRoleDTO>> response = await _rolesService.GetListAsync(request);
        ...
        public async Task<IActionResult> Edit(PrivateBlogRoleDTO dto)
        {
            if (!ModelState.IsValid)
            {
                ...
                Response<List<PermissionForDTO>> permissionsByRoleResponse = await _rolesService.GetPermissionsByRoleAsync(dto.Id);
                Response<List<SectionForDTO>> sectionsByRoleResponse = await _rolesService.GetSectionsByRoleAsync(dto.Id);
            ...
            Response<List<PermissionForDTO>> permissionsByRoleResponse2 = await _rolesService.GetPermissionsByRoleAsync(dto.Id);
            Response<List<SectionForDTO>> sectionsByRoleResponse2 = await _rolesService.GetSectionsByRoleAsync(dto.Id);
