...
{
    [RequirePermission(PermissionCodesCatalog.ShowRoles)]
    public class RolesController : Controller
    {
        ...
        [HttpGet]
        [RequirePermission(PermissionCodesCatalog.CreateRoles)]
        ...
        [HttpGet]
        [RequirePermission(PermissionCodesCatalog.UpdateRoles)]
        ...
        [HttpPost]
        [RequirePermission(PermissionCodesCatalog.DeleteRoles)]
