...
{
    [RequirePermission(PermissionCodesCatalog.ShowUsers)]
    public class UsersController : Controller
    {
        ...
        [HttpGet]
        [RequirePermission(PermissionCodesCatalog.CreateUsers)]
        ...
        [HttpGet]
        [RequirePermission(PermissionCodesCatalog.UpdateUsers)]
        ...
        [HttpPost]
        [RequirePermission(PermissionCodesCatalog.DeleteUsers)]
